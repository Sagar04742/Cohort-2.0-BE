...
const IconUser = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
    <circle cx="12" cy="8" r="3.6"/><path d="M4.5 20c1.4-4 4-5.8 7.5-5.8s6.1 1.8 7.5 5.8"/>
  </svg>
);
const IconMail = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: 21, fontWeight: 600, color: "#fff", textAlign: "center", margin: "0 0 6px", letterSpacing: -0.3 }}>
          Create your account
        </h2>
        ...
        <form onSubmit={handleSubmit}>
          <FieldInput
            label="Username" icon={<IconUser />} type="text"
          ...
          >
            {submitting ? <Spinner /> : <>Create account <IconArrow /></>}
          </button>
        </form>
