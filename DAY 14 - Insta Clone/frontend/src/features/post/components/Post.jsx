...
const Post = ({ user, post, currentUser, onToggleLike }) => {
  return (
    <div className="post">
      <div className="user">
        ...
        <div className="user-meta">
          ...
          <span className="post-info">{post.likeCount ?? 0} likes</span>
        </div>
      </div>
      ...
      <div className="icons">
        <div className="left">
          <button
            onClick={() => onToggleLike?.(post._id, post.isLiked)}
            className="icon-button"
            aria-label={post.isLiked ? "Remove like" : "Like post"}
          >
            <svg
